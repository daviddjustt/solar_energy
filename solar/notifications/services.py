...
def _construir_mensagem_notificacao(projeto, evento, context, sender=None):
    ...
    if evento == 'documento_rejeitado':
        ...
        email_data = {
            ...
            'template': 'email/cliente/documento_rejeitado.html',
        ...
        email_data = {
            ...
            'template': 'email/cliente/documento_aprovado.html',
        ...
        email_data = {
            ...
            'template': 'email/cliente/boleto_disponivel.html',
        ...
        email_data = {
            ...
            'template': 'email/cliente/status_alterado.html',
    ...
    # --- NOVOS EVENTOS: DOCUMENTOS DIRETOS DO USUÁRIO ---
        ...
        email_data = {
            ...
            'template': 'email/cliente/user_boleto_disponivel.html',
