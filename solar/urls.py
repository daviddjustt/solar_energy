...
from solar.users.views import CustomUserViewSet, ActivateAccountView, FilteredUserListView, OnlyClientes
...
urlpatterns = [
    ...
    path('filter/clients/', OnlyClientes.as_view(), name='filtered-user-list'),
]
