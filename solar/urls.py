...
from solar.users.views import CustomUserViewSet, ActivateAccountView, FilterPerRole
...
urlpatterns = [
    ...
    path('filter/<str:user_type>/', FilterPerRole.as_view(), name='filtered-user-list'),
]
